      ...
      <div className="max-w-6xl mx-auto flex flex-col lg:flex-row gap-6">
        ...
        <div className={`transition-all duration-300 ${((gameMode === 'competitive' || gameMode === 'competitive_turns') && gameStarted) ? 'lg:w-3/4' : 'max-w-2xl mx-auto w-full'}`}>
          ...
          <div className="text-center mb-4">
            <div className="relative w-80 h-40 mx-auto mb-0">
              <Image src="/oldyfunlogo2.svg" alt="Oldy Fun Music Box" fill className="object-contain" />
            </div>
            {user && <p className="text-muted-foreground text-sm -mt-6">Jugador: <span className="text-foreground font-medium">{user.firstname}</span></p>}
          </div>
                ...
                {!gameMode && !isActiveCasualSession && !isActiveCompetitiveSession && (
                  <div className="space-y-4">
                    ...
                    <div onClick={() => handleModeSelection('casual')} className="p-4 rounded-lg border border-border bg-background hover:border-primary cursor-pointer transition-all flex gap-4 items-center group">
                      <div className="bg-primary p-3 rounded-full text-primary-foreground"><Music2 className="w-6 h-6" /></div>
                    ...
                    <div onClick={() => handleModeSelection('competitive')} className="p-4 rounded-lg border border-border bg-background hover:border-primary cursor-pointer transition-all flex gap-4 items-center group">
                      <div className="bg-primary p-3 rounded-full text-primary-foreground"><Users className="w-6 h-6" /></div>
                    ...
                    <div onClick={() => handleModeSelection('competitive_turns')} className="p-4 rounded-lg border border-border bg-background hover:border-primary cursor-pointer transition-all flex gap-4 items-center group">
                      <div className="bg-primary p-3 rounded-full text-primary-foreground"><Smartphone className="w-6 h-6" /></div>
                          ...
                          {embedUrl ? (
                            <div className="relative w-full">
                              ...
                              <button
                                ...
                                disabled={revealing}
                                className="absolute top-0 left-0 w-full h-full bg-[#2a2a2a] text-white rounded-lg font-bold hover:bg-[#3a3a3a] transition-colors shadow-xl flex flex-col items-center justify-center z-10 gap-1 md:gap-3"
                                style={{
                              ...
                              >
                                {revealing ? (
                                  ...
                                  <>
                                    <Eye className="w-10 h-10 md:w-12 md:h-12" color="#009bdd" strokeWidth={2} />
                                    <span className="text-lg md:text-xl tracking-widest uppercase text-center">Revelar Respuesta</span>
                                  </>
                                )}
                              </button>
                            </div>
